...
Essa análise é baseada em dados gerados por viagens de avião entre os anos de 2000 e 2024, abrangendo todos os aeroportos do mundo. Esses dados são cruciais para analisar tendências no transporte aéreo e os impactos de eventos globais no sistema aeroviário. **Atualizado em: 2024-08-20**
...
# Exibir a tabela em formato de Markdown ou HTML
...
```{r mapa14, include=TRUE,  echo=FALSE}

# Carregar dados dos estados brasileiros (shapefile)
brasil_states <- read_state(year = 2020) 
...
```{r mapa2019, include=TRUE,  echo=FALSE}
...
#datatable(head(df_19,30), options = list(scrollX = TRUE))
